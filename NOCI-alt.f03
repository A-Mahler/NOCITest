program NOCI
  ...
  type(mqc_scf_integral)::Gmat,rho_int,temp_int
  type(mqc_twoERIs)::ERI
  type(mqc_vector)::S_vec,S_inv,E_NOCI
  type(mqc_matrix)::core_ham,overlap,Hmat,Nmat,MO_I,MO_J,rho,eigenvecs,MIJ,MIJ_inv,ti,tj
  type(mqc_matrix)::Umat,Vmat,tmoI,tmoJ,Smat,tmat1,tmat2,tmat3,tmat4
